...
public:
	...
	void insert(iterator position, InputIterator first, InputIterator last)
	{
		...
		{
			//To implement this we might be able to call erase() on position and then use push_back like the above case
			std::cerr << "Error. Inserting elements at positions other than the end of the vec is not yet supported. Exiting." << std::endl;
			exit(-1);
		}
	}
